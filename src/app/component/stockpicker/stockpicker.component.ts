...
export class StockpickerComponent implements OnInit {
  ...
  constructor(private iex: IEXService, private portfolio: PortfolioService) { }
      ...
      data => {
        ...
        for (let o of this.stocks) {
          this.portfolio.getPortfolios().subscribe(
            data2 => {
              this.portfolios = data2["portfolios"]
              ...
              hSymbol.setAttribute("value",o["symbol"])
              results.appendChild(hSymbol);
